...
const projects = [
  {
    ...
    description: "A modern and responsive portfolio built with Next.js, Tailwind CSS, and Framer Motion. Features animated particle background.",
    image: "/p6.png",
  ...
  },
  {
    ...
    category: "Web Development",
    description: "Elegant restaurant site with online reservation system.",
    image: "/p1.png",
  ...
  },
  {
    ...
    category: "Web Development",
    description: "Personal portfolio site for a designer.",
    image: "/p2.png",
